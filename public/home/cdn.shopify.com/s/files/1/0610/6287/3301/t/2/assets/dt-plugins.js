/* jquery.zoom.min.js */ ! function(e) {
    ...
    e.zoom = function(t, n, i, o) {
        ...
        return p.css("position", /(absolute|fixed)/.test(f) ? f : "relative"), p.css("overflow", "hidden"), i.style.width = i.style.height = "", e(i).addClass("zoomImg").css({
            ...
            init: function() {
                s = p.outerWidth(), r = p.outerHeight(), n === p[0] ? (l = s, a = r) : (l = h.outerWidth(), a = h.outerHeight()), c = (i.width - s) / l, u = (i.height - r) / a, d = h.offset()
            },
            move: function(e) {
        ...
        return this.each(function() {
            ...
            (o.url || (i = a.find("img"), i[0] && (o.url = i.data("src") || i.attr("src")), o.url)) && (! function() {
                ...
                a.one("zoom.destroy", function() {
                    a.off(".zoom"), l.css("position", e), l.css("overflow", t), u.remove()
                })
            }(), c.onload = function() {
                function t(t) {
                    i.init(), i.move(t), u.stop().fadeTo(e.support.opacity ? o.duration : 0, 1, !!e.isFunction(o.onZoomIn) && o.onZoomIn.call(c))
                }

                function n() {
                    u.stop().fadeTo(o.duration, 0, !!e.isFunction(o.onZoomOut) && o.onZoomOut.call(c))
                }
                ...
                }), e.isFunction(o.callback) && o.callback.call(c)
            }, c.src = o.url)
        })
...
function() {
    ...
    function b(e, t, n, i, o, r) {
        ...
        var d = "[object Object]" == c && !a(e),
            l = "[object Object]" == u && !a(t);
        return !(u = c == u) || s || d ? 2 & o || (c = d && Te.call(e, "__wrapped__"), l = l && Te.call(t, "__wrapped__"), !c && !l) ? !!u && (r || (r = []), (c = M(r, function(t) {
            return t[0] === e
        })) && c[1] ? c[1] == t : (r.push([e, t]), t = (s ? q : _)(e, t, n, i, o, r), r.pop(), t)) : n(c ? e.value() : e, l ? t.value() : t, i, o, r) : L(e, t, c)
    }
    ...
    function k(e, t) {
        var n = -1,
            i = Y(e) ? Array(e.length) : [];
        return qe(e, function(e, o, r) {
            i[++n] = t(e, o, r)
        }), i
    }
    ...
    function H(e, t, n) {
        function i() {
            for (var r = -1, s = arguments.length, a = -1, l = n.length, c = Array(l + s), u = this && this !== xe && this instanceof i ? o : e; ++a < l;) c[a] = n[a];
    ...
    function R(e, t) {
        return qe(e, "function" == typeof t ? t : se)
    }

    function W(e, t, n) {
        return i(e, x(t), n, 3 > arguments.length, qe)
    }
    ...
    function U(e) {
        var t;
        if ("function" != typeof e) throw new TypeError("Expected a function");
        return t = He(t === le ? e.length - 1 : We(t), 0),
            function() {
                for (var n = arguments, i = -1, o = He(n.length - t, 0), r = Array(o); ++i < o;) r[i] = n[t + i];
    ...
    function V(e) {
        return Z(e) && Y(e) && Te.call(e, "callee") && (!Oe.call(e, "callee") || "[object Arguments]" == Ee.call(e))
    }
    ...
    function G(e) {
        return e = J(e) ? Ee.call(e) : "", "[object Function]" == e || "[object GeneratorFunction]" == e
    }
    ...
    function ee(e) {
        return "string" == typeof e || !Re(e) && Z(e) && "[object String]" == Ee.call(e)
    }
    ...
    function ie(e) {
        var t = F(e);
        if (!t && !Y(e)) return Pe(Object(e));
        var n, i = I(e),
            o = !!i,
            i = i || [],
            r = i.length;
        for (n in e) !Te.call(e, n) || o && ("length" == n || l(n, r)) || t && "constructor" == n || i.push(n);
        return i
    }
    ...
    var le, ce = 1 / 0,
        ...
        ye = he[typeof module] && module && !module.nodeType ? module : le,
        ge = ye && ye.exports === ve ? ve : le,
        me = r(he[typeof self] && self),
    ...
    var _e = E("length"),
        Ie = U(function(t, n) {
            return Re(t) || (t = null == t ? [] : [Object(t)]), y(n, 1), e(A(t), re)
        }),
        Fe = U(function(e, t, n) {
            return H(e, t, n)
        }),
        ...
        Ve = N(function(e, t, n, i) {
            O(t, oe(t), e, i)
        }),
        Ye = U(function(e) {
            return e.push(le, d), Ve.apply(le, e)
        }),
        Ge = U(function(e, t) {
            return null == e ? {} : C(e, y(t, 1))
        }),
        Qe = x;
    u.prototype = p(c.prototype), u.prototype.constructor = u, c.assignIn = Xe, c.before = B, c.bind = Fe, c.chain = function(e) {
        return e = c(e), e.__chain__ = !0, e
    }, c.compact = function(e) {
        return v(e, Boolean)
    }, c.concat = Ie, c.create = function(e, t) {
        var n = p(e);
        return t ? Ue(n, t) : n
    }, c.defaults = Ye, c.defer = ze, c.delay = Me, c.filter = function(e, t) {
        return v(e, x(t))
    }, c.flatten = function(e) {
        return e && e.length ? y(e, 1) : []
    }, c.flattenDeep = function(e) {
        return e && e.length ? y(e, ce) : []
    }, c.iteratee = Qe, c.keys = ie, c.map = function(e, t) {
        return k(e, x(t))
    }, c.matches = function(e) {
        return T(Ue({}, e))
    }, c.mixin = ae, c.negate = function(e) {
        if ("function" != typeof e) throw new TypeError("Expected a function");
        return function() {
        ...
        return B(2, e)
    }, c.pick = Ge, c.slice = function(e, t, n) {
        var i = e ? e.length : 0;
        ...
        return Y(e) ? e.length ? A(e) : [] : re(e)
    }, c.values = re, c.extend = Xe, ae(c, c), c.clone = function(e) {
        return J(e) ? Re(e) ? A(e) : O(e, ie(e)) : e
    }, c.escape = function(e) {
        return (e = ne(e)) && de.test(e) ? e.replace(ue, s) : e
    }, c.every = function(e, t, n) {
        return t = n ? le : t, h(e, x(t))
    }, c.find = M, c.forEach = R, c.has = function(e, t) {
        return null != e && Te.call(e, t)
    }, c.head = z, c.identity = se, c.indexOf = function(e, t, n) {
        var i = e ? e.length : 0;
        ...
        return -1
    }, c.isArguments = V, c.isArray = Re, c.isBoolean = function(e) {
        return !0 === e || !1 === e || Z(e) && "[object Boolean]" == Ee.call(e)
    }, c.isDate = function(e) {
        return Z(e) && "[object Date]" == Ee.call(e)
    }, c.isEmpty = function(e) {
        if (Y(e) && (Re(e) || ee(e) || G(e.splice) || V(e))) return !e.length;
        for (var t in e)
        ...
        return "number" == typeof e && Ne(e)
    }, c.isFunction = G, c.isNaN = function(e) {
        return K(e) && e != +e
    }, c.isNull = function(e) {
        return null === e
    }, c.isNumber = K, c.isObject = J, c.isRegExp = function(e) {
        return J(e) && "[object RegExp]" == Ee.call(e)
    }, c.isString = ee, c.isUndefined = function(e) {
        return e === le
    }, c.last = function(e) {
        var t = e ? e.length : 0;
        return t ? e[t - 1] : le
    ...
    }, c.noop = function() {}, c.reduce = W, c.result = function(e, t, n) {
        return t = null == e ? le : e[t], t === le && (t = n), G(t) ? t.call(e) : t
    }, c.size = function(e) {
        return null == e ? 0 : (e = Y(e) ? e : ie(e), e.length)
        ...
        var e = {};
        return g(c, function(t, n) {
            Te.call(c.prototype, n) || (e[n] = t)
        }), e
    }(), {
        chain: !1
    }), c.VERSION = "4.5.1", qe("pop join replace reverse split push shift sort splice unshift".split(" "), function(e) {
    ...
    }, (we || me || {})._ = c, "function" == typeof define && "object" == typeof define.amd && define.amd ? define(function() {
        return c
    }) : ve && ye ? (ge && ((ye.exports = c)._ = c), ve._ = c) : xe._ = c
}.call(this),
    /*!
        ...
        i.fn.StickySidebar = function(t) {
            function o(t, o) {
                return !0 === t.initialized || !(i("body").width() < t.minWidth) && (function(t, o) {
                    t.initialized = !0, i("head").append(i('<style>.StickySidebar:after {content: ""; display: table; clear: both;}</style>')), o.each(function() {
                        var o = {};
                        o.sidebar = i(this), o.options = t || {}, o.container = i(o.options.containerSelector), 0 == o.container.length && (o.container = o.sidebar.parent()), o.sidebar.parents().css("-webkit-transform", "none"), o.sidebar.css({
                            position: "relative",
                            overflow: "visible",
                            "-webkit-box-sizing": "border-box",
                            "-moz-box-sizing": "border-box",
                            "box-sizing": "border-box"
                        }), o.stickySidebar = o.sidebar.find(".StickySidebar"), 0 == o.stickySidebar.length && (o.sidebar.find("script").remove(), o.stickySidebar = i("<div>").addClass("StickySidebar").append(o.sidebar.children()), o.sidebar.append(o.stickySidebar)), o.marginTop = parseInt(o.sidebar.css("margin-top")), o.marginBottom = parseInt(o.sidebar.css("margin-bottom")), o.paddingTop = parseInt(o.sidebar.css("padding-top")), o.paddingBottom = parseInt(o.sidebar.css("padding-bottom"));
                        var e = o.stickySidebar.offset().top,
                        ...
                        o.stickySidebar.css("padding-top", 1), o.stickySidebar.css("padding-bottom", 1), e -= o.stickySidebar.offset().top, a = o.stickySidebar.outerHeight() - a - e, 0 == e ? (o.stickySidebar.css("padding-top", 0), o.stickySidebarPaddingTop = 0) : o.stickySidebarPaddingTop = 1, 0 == a ? (o.stickySidebar.css("padding-bottom", 0), o.stickySidebarPaddingBottom = 0) : o.stickySidebarPaddingBottom = 1, o.previousScrollTop = null, o.fixedScrollTop = 0, n(), o.onScroll = function(o) {
                            if (o.stickySidebar.is(":visible"))
                                if (i("body").width() < o.options.minWidth) n();
                                else {
                                    if (o.options.disableOnResponsiveLayouts) {
                                        var e = o.sidebar.outerWidth("none" == o.sidebar.css("float"));
                                        if (e + 50 > o.container.width()) return void n()
                                    }
                                    var a, d, s = i(document).scrollTop(),
                                        r = "static";
                                    if (s >= o.container.offset().top + (o.paddingTop + o.marginTop - o.options.additionalMarginTop)) {
                                        var c, p = o.paddingTop + o.marginTop + t.additionalMarginTop,
                                            b = o.paddingBottom + o.marginBottom + t.additionalMarginBottom,
                                            l = o.container.offset().top,
                                            g = o.container.offset().top + (a = o.container, d = a.height(), a.children().each(function() {
                                                d = Math.max(d, i(this).height())
                                            }), d),
                                            f = 0 + t.additionalMarginTop,
                                            h = o.stickySidebar.outerHeight() + p + b < i(window).height();
                                        c = h ? f + o.stickySidebar.outerHeight() : i(window).height() - o.marginBottom - o.paddingBottom - t.additionalMarginBottom;
                                        var S = l - s + o.paddingTop + o.marginTop,
                                            u = g - s - o.paddingBottom - o.marginBottom,
                                            m = o.stickySidebar.offset().top - s,
                                            y = o.previousScrollTop - s;
                                        "fixed" == o.stickySidebar.css("position") && "modern" == o.options.sidebarBehavior && (m += y), "stick-to-top" == o.options.sidebarBehavior && (m = t.additionalMarginTop), "stick-to-bottom" == o.options.sidebarBehavior && (m = c - o.stickySidebar.outerHeight()), m = y > 0 ? Math.min(m, f) : Math.max(m, c - o.stickySidebar.outerHeight()), m = Math.max(m, S), m = Math.min(m, u - o.stickySidebar.outerHeight());
                                        var k = o.container.height() == o.stickySidebar.outerHeight();
                                        r = (k || m != f) && (k || m != c - o.stickySidebar.outerHeight()) ? s + m - o.sidebar.offset().top - o.paddingTop <= t.additionalMarginTop ? "static" : "absolute" : "fixed"
                                    }
                                    if ("fixed" == r) o.stickySidebar.css({
                                        position: "fixed",
                                        ...
                                        var T = {};
                                        "absolute" != o.stickySidebar.css("position") && (T.position = "absolute", T.top = s + m - o.sidebar.offset().top - o.stickySidebarPaddingTop - o.stickySidebarPaddingBottom), T.width = o.sidebar.width(), T.left = "", o.stickySidebar.css(T)
                                    } else "static" == r && n();
