            ...
            BOOMR_start = (new Date).getTime(), e(),
                function(t) {
                    ...
                    if (t.parent !== t && document.getElementById("boomr-if-as") && "script" === document.getElementById("boomr-if-as").nodeName.toLowerCase() && (t = t.parent), i = t.document, t.BOOMR || (t.BOOMR = {}), BOOMR = t.BOOMR, !BOOMR.version) {
                        if (BOOMR.version = "2.3.2", BOOMR.window = t, BOOMR.boomerang_frame = u, BOOMR.plugins || (BOOMR.plugins = {}), function() {
                                try {
        ...
        function() {
            ...
            if (BOOMR = window.BOOMR || {}, BOOMR.plugins = BOOMR.plugins || {}, !BOOMR.plugins.ResourceTiming) {
                ...
                e = {
                    ...
                    init: function(t) {
                        if (BOOMR.utils.pluginConfig(e, t, "ResourceTiming", ["xssBreakWords", "clearOnBeacon", "urlLimit", "trimUrls", "trackedResourceTypes", "serverTiming", "monitorClearResourceTimings", "splitAtPath", "getSrcsetDimensions"]), e.trackedResourceTypes = ["script", "img", "css", "link", "early-hints"], e.initialized) return this;
                    ...
                    for (p = 0; C && p < C.length; p++)
                        if (_ = C[p], !(P >= 10 && s(_))) {
                            y = {
                                ...
                                latestTime: (M = _, M.responseEnd ? M.responseEnd : M.responseStart && M.startTime ? M.responseStart + .2 * (M.responseStart - M.startTime) : 1 / 0)
                            };
