(() => {
    ...
    function r(e, t) {
        "ON" === n && console && console.warn && console.warn(`[pixel_shop_events_listener] Error in ${e}:  ${t.message}`)
    }
    ...
    function s(e, t, n) {
        ...
        t.forEach(((t, o) => {
            ...
            try {
                ...
                r("handleBulkItemCartAddResponse", s)
            }
            a(e, t, i)
        }))
    }
    ...
    function a(n, o, r) {
        const i = ((null === (c = null === (l = t()) || void 0 === l ? void 0 : l.ShopifyAnalytics) || void 0 === c ? void 0 : c.meta) || {}).currency,
            s = {
                id: String(o.id),
                image: {
                    src: o.image
    ...
    class l {
        ...
        static handleXhrDone(e) {
            try {
                ...
                l.ADD_TO_CART_REGEX.test(n) && l.parsePayloadResponse(e, (t => {
        ...
        onReadyStateChange() {
            this.xhr.readyState === XMLHttpRequest.DONE && l.handleXhrDone({
                method: this.method,
                url: this.url,
                body: this.body,
                xhr: this.xhr,
    ...
    function u(n, u) {
        ! function(e, t) {
            ...
            e.prototype.open = function(e, t) {
                ...
                if (!(e instanceof Document)) {
                    const n = new l(this, this._url, this._method, e || "", t);
        ...
        function(e, t) {
            ...
            function i(e, n) {
                const o = c(n);
                e.clone().json().then((e => a(t, e, o))).catch(u)
            }

            function u(e) {
                r("handleFetchRequest", e)
            }
            ...
            i && i.indexOf("/cart/add") >= 0 && o(t, "submit", (t => {
                ! function(t, n, o) {
    ...
    function d(e, t, s) {
        var a;
        null != s && s.logLevel && (a = s.logLevel, n = a), u(e, t),
            function(e, t) {
                i((n => {
                    const i = n.querySelector('[name="previous_step"]');
                    i && i instanceof HTMLInputElement && "payment_method" === i.value && o(document.body, "submit", (n => {
                        ! function(e, t, n) {
    ...
    l.ADD_TO_CART_REGEX = /^(?:\/[a-zA-Z]+(?:-[a-zA-Z]+)?)?\/cart\/add(?:\.js|\.json)?$/;
    const p = "0.0.177",
        f = {
            ...
            eventPublish: "web_pixels_manager_event_publish/1.0"
        };
        ...
        for (const n in e)
            if (Object.prototype.hasOwnProperty.call(e, n)) {
                const o = n.replace(/[A-Z]/g, (e => `_${e}`)).toLowerCase(),
                    r = e[n];
                t[o] = null !== r && "object" == typeof r ? b(r) : r
            }
        return t
    }
    class y extends Error {
        constructor(...e) {
            super(...e), Error.captureStackTrace && Error.captureStackTrace(this, y)
        }
    }
    const g = (e, t) => {
        var n;
        ...
        if (e.stackTrace || e.stack || e.description) {
            ...
            if (t && t.length > 2 && (i.lineNumber = t[1], i.columnNumber = t[2], parseInt(i.lineNumber, 10) > 1e5)) return
        }
        fetch("https://notify.bugsnag.com", {
            ...
            body: JSON.stringify({
                ...
                events: [{
                    ...
                    metaData: {
                        device: {
                            userAgent: null === (n = self.navigator) || void 0 === n ? void 0 : n.userAgent
                        },
                        request: {
                            shopId: o.shopId,
    ...
    function S() {
        ...
        _.length = 0,
            function(e) {
                ...
                ! function(e) {
                    const t = `${{global:"https://monorail-edge.shopifysvc.com",wellKnown:`${w}/.well-known/shopify/monorail`,staging:"https://monorail-edge-staging.shopifycloud.com",test:"https://localhost"}[E]}/unstable/produce_batch`;
                    try {
                        if (self.navigator.sendBeacon.bind(self.navigator)(t, e)) return !0
                    } catch (o) {}
                    const n = new XMLHttpRequest;
                    try {
                        n.open("POST", t, !0), n.setRequestHeader("Content-Type", "text/plain"), n.send(e)
                    } catch (r) {
                        g(r, {
    ...
    class T {
        constructor(e = R) {
            this.channelSubscribers = new Map, this.replayQueue = void 0, this.options = void 0, this.options = e, this.replayQueue = new P(e.bufferSize, e.replayKeep)
        }
        publish(e, t, n = {}) {
            var o;
            ...
            var i;
            return null === (o = this.channelSubscribers.get(e)) || void 0 === o || o.forEach(r), this.options.enableSubscribeAll && (null === (i = this.channelSubscribers.get(this.options.subscribeAllKey)) || void 0 === i || i.forEach(r)), !0
        }
        subscribe(e, t, n = {}) {
    ...
    const O = ["checkout_completed", "checkout_started", "payment_info_submitted", "collection_viewed", "page_viewed", "product_added_to_cart", "product_viewed", "product_variant_viewed", "search_submitted"],
        D = ["all_events", "all_standard_events", "all_custom_events", "checkout_completed", "checkout_started", "payment_info_submitted", "collection_viewed", "page_viewed", "product_added_to_cart", "product_viewed", "product_variant_viewed", "search_submitted"];
    ...
    function te() {
        try {
            let e = function() {
                let e;
                if ((document.cookie ? document.cookie.split("; ") : []).forEach((t => {
                        const [n, o] = t.split("=");
                        if ("_tracking_consent" === decodeURIComponent(n)) {
                            var r = JSON.parse(decodeURIComponent(o));
                            e = r
                        }
                    })), void 0 !== e && (t = e, [j.V2_0, j.V2_1].includes(t.v) && function(e, t) {
                        const n = t.slice().sort();
                        return e.length === t.length && e.slice().sort().every(((e, t) => e === n[t]))
                    }(Object.keys(t), Y))) return e;
                var t
            }();
            if (!e) return;
            return e.v === j.V2_0 ? function(e) {
                const t = Z(Z({}, e.con), {}, {
                    GDPR: re(e) ? oe(e.con.GDPR) : void 0
                });
                return void 0 === t.GDPR && delete t.GDPR, {
                    con: t,
                    reg: e.reg,
                    v: j.V2_1,
                    lim: e.lim
    ...
    function re(e) {
        const t = [$.GDPR, $.GDPR_BLOCK_ALL];
        return e.lim.some((e => t.includes(e))) && B.GDPR in e.con
    }

    function ie() {
        if (!ae($.GDPR) && !ae($.GDPR_BLOCK_ALL)) return !0;
        const e = function() {
            const e = te();
            if (ne(e)) return oe(M.NO_VALUE);
            const t = e.con;
            switch (typeof t.GDPR) {
                case "undefined":
                    return oe(M.NO_VALUE);
                case "string":
                    return oe(t.GDPR);
                default:
                    return t.GDPR
        ...
        return e[G.MARKETING] === M.ACCEPTED && e[G.STATISTICS] === M.ACCEPTED || e[G.MARKETING] !== M.DECLINED && e[G.STATISTICS] !== M.DECLINED && function() {
            const e = function() {
                const e = te();
                return ne(e) ? B.NO_VALUE : e.reg
            }();
            return e in B ? e : B.NO_VALUE
        }() !== B.GDPR
    }
    ...
    function ce(e) {
        document.addEventListener(N.TRACKING_ACCEPTED, e)
    }
    $.GDPR, $.GDPR_BLOCK_ALL, $.CCPA_BLOCK_ALL, $.CCPA;
    const le = ["[object String]", "[object Number]", "[object Boolean]", "[object Undefined]", "[object Null]"];
    ...
    function ue(e) {
        ...
        return void 0 === e || n(e) ? {
            isValid: function e(o) {
                ...
                const r = le.includes(Object.prototype.toString.call(o));
                return r || (t = `${o} must be one of the following types: ${le.join(", ")}`), r
            }(e),
            error: t
    ...
    const me = [];
    for (let Me = 0; Me < 256; ++Me) me.push((Me + 256).toString(16).slice(1));
    const be = function(e, t, n) {
        if (de.randomUUID && !t && !e) return de.randomUUID();
        const o = (e = e || {}).random || (e.rng || he)();
    ...
    const we = Symbol.for("RemoteUi::Retain"),
        ve = Symbol.for("RemoteUi::Release"),
        Ee = Symbol.for("RemoteUi::RetainedBy");
    class Ce {
        constructor() {
            this.memoryManaged = new Set
        }
        add(e) {
            this.memoryManaged.add(e), e[Ee].add(this), e[we]()
        }
        release() {
            for (const e of this.memoryManaged) e[Ee].delete(this), e[ve]();
            this.memoryManaged.clear()
        }
    }

    function _e(e) {
        return Boolean(e && e[we] && e[ve])
    }
    ...
    function xe(e, {
        ...
        const n = _e(e);
        if (n && e[we](), t) {
            if (Array.isArray(e)) return e.reduce(((e, n) => xe(n, {
                deep: t
            }) || e), n);
            if ("object" == typeof e && null != e) return Object.keys(e).reduce(((n, o) => xe(e[o], {
                deep: t
            }) || n), n)
        }
        return n
    ...
    function Re(e, t, n, o, r, i = !1) {
        ...
        return {
            analytics: {
                subscribe: (r, s, a) => (i && xe(s), e.subscribe(r, s, { ...a,
            ...
            browser: {
                ...
                sendBeacon: async (e, t = "") => {
                    if (e.includes(self.location.origin)) return !1;
            ...
            init: (a = r, {
                ...
                data: {
                    customer: (f = null == a ? void 0 : a.customer, f ? {
                        ...
                        email: null == f ? void 0 : f.email,
                        phone: null == f ? void 0 : f.phone
                    } : null),
                    cart: (c = null == a ? void 0 : a.cart, c ? {
                        ...
                        cost: {
                            totalAmount: {
                                ...
                                currencyCode: null == c || null === (d = c.cost) || void 0 === d || null === (p = d.totalAmount) || void 0 === p ? void 0 : p.currencyCode
                            }
                        },
    ...
    function De({
        ...
        shopId: n,
        storefrontBaseUrl: o,
        webPixelsExtensionBaseUrl: r,
        surface: i,
        initData: s
    }) {
        const a = [r, "/app", "/services", `/${n}`, "/web-pixels-manager", `/${e.type.toLowerCase()}`, `/web-pixel-${e.id}`, `@${e.scriptVersion}.js`].join("");
        let c;
        if (e.type === Oe.App || e.runtimeContext === Te.Strict) {
            const e = [m(o), "/web-pixels-manager", "@0.0.177", "/sandbox", "/worker.modern.js"];
            o.match(/spin\.dev\/?/) && e.push("?fast_storefront_renderer=1"), c = new Worker(e.join(""))
        } else {
            let {
                search: t
            } = window.location;
            o.match(/spin\.dev\/?/) && (t = `${t}${t.length?"&":"?"}fast_storefront_renderer=1`);
            const n = [m(o), "/web-pixels-manager@0.0.177", "/sandbox", window.location.pathname, t].join("");
            c = function(e, {
                terminate: t = !0,
                targetOrigin: n = "*"
            } = {}) {
                ...
                if (t) i.setAttribute("src", t);
                    ...
                    if (!n) {
                        const e = new y("src or srcdoc must be provided");
                        throw g(e, {
                ...
                return i.setAttribute("id", `sandbox-${e}`), i.setAttribute("sandbox", o.join(" ")), i.setAttribute("tabIndex", "-1"), i.setAttribute("aria-hidden", "true"), i.setAttribute("style", "display:none; height:0; width:0; visibility: hidden;"),
                    function(e) {
                ...
                id: `web-pixel-extension-${e.type}-${e.id}`,
                src: n,
        ...
        const l = function(e, {
            ...
            d = {
                cookieRestrictedDomains: async () => function() {
                    const e = [];
                    return self.location.hostname.split(".").reverse().reduce(((t, n) => {
                        const o = "" === t ? n : `${n}.${t}`;
                        return r = o, document.cookie = `wpm-domain-test=1; path=/; domain=${r}`, document.cookie.split(";").find((e => e.includes("wpm-domain-test"))) || e.push(o),
                            function(e) {
        ...
        l.expose({
            pixelRuntimeAPI: () => u,
            sandboxInternalAPI: () => d
        });
        const f = self.document.title;
        return l.call.initialize(f, a, e), ce((() => {
            l.call.initWebPixelsAwaitingConsent()
        })), {
            config: e,
            endpoint: l
        }
    ...
    function ke(e) {
        return e.type === Oe.Custom ? "-1" : e.apiClientId ? `${e.apiClientId}` : void 0
    }! function(e) {
    ...
    const Le = "all_standard_events",
        Ne = "all_custom_events";
    ...
    const Ue = function() {
        ...
        try {
            const t = new Map;
            return e.payload.status = "loaded", x(e), {
                init(e) {
                    const {
                        shopId: n,
                        storefrontBaseUrl: o,
                    ...
                    v(o),
                        ...
                        }(c).isEnabled("web_pixels_use_shop_domain_monorail_endpoint") && (E = C("wellKnown"));
                    const l = function(e) {
                            const t = new T({
                            ...
                            return e.initData, {
                                publish(n, o, r) {
                                    ...
                                    const l = function(e, t, n) {
                                        return {
                                            id: be(),
                                            clientId: ge(document.cookie)._shopify_y,
                                    ...
                                    return A("eventPublish", {
                                        ...
                                        extensionType: null == r || null === (a = r.extension) || void 0 === a ? void 0 : a.type
                                    }, !0), t.publish(n, l)
                                },
                                    ...
                                    const s = e => {
                                        o.gate((() => {
                                            ...
                                            r(e), A("subscriberEventEmit", {
                                                ...
                                                pixelAppId: ke(i.pixelRuntimeConfig),
                                                ...
                                                eventName: e.name,
                                                eventType: k(e.name) ? "standard" : "custom"
                                            }, !0)
                                        }))
                                    };
                                    if ("all_events" === e) {
                                        const e = t.subscribe(Le, s, i),
                                            o = n.subscribe(Ne, s, i);
                                        return () => e() && o()
                                    }
                                    return e === Ne ? n.subscribe(Ne, s, i) : e === Le || L(e) ? t.subscribe(e, s, i) : n.subscribe(e, s, i)
                                }
                            }
                        }(e),
                        u = e.webPixelsExtensionBaseUrl || e.webPixelExtensionBaseUrl,
                        f = {
                            severity: "warning",
                    ...
                    try {
                        if (!n) {
                            const e = new y("WebPixelsManager: shopId is required");
                            throw g(e, f), e
                        }
                        if (!o) {
                            const e = new y("WebPixelsManager: storefrontBaseUrl is required");
                            throw g(e, f), e
                        }
                        if (!je(o)) {
                            const e = new y(`WebPixelsManager: storefrontBaseUrl is not a valid absolute URL: ${o}`);
                            throw g(e, f), e
                        }
                        if (!u) {
                            const e = new y("WebPixelsManager: webPixelsExtensionBaseUrl is required");
                            throw g(e, f), e
                        }
                        if (!je(u)) {
                            const e = new y(`WebPixelsManager: webPixelsExtensionBaseUrl is not a valid absolute URL: ${u}`);
                            throw g(e, f), e
                        }
                        if (!r) {
                            const e = new y("WebPixelsManager: cdnBaseUrl is required");
                            throw g(e, f), e
                        }
                        if (!je(r)) {
                            const e = new y(`WebPixelsManager: cdnBaseUrl is not a valid absolute URL: ${r}`);
                            throw g(e, f), e
                        }
                        return i.forEach((e => {
                            const i = (c = e.id, `${e.type.toLowerCase()}/${c}`);
                            var c;
                            if (!t.has(i) && function(e) {
                                    const t = {
                                    ...
                                    return e.type === Oe.App && (t.configuration = "string"), Object.keys(e).filter((n => Object.prototype.hasOwnProperty.call(t, n) && typeof e[n] === t[n])).length === Object.keys(t).length
                                }(e)) {
                                const c = De({
                                    webPixelConfig: e,
                                    eventBus: l,
                        ...
                        })), "checkout-one" !== s && d(l.publish, a), m.payload.status = "initialized", x(m), {
                            publish: (e, t, n = {}) => l.publish(e, t),
                            publishCustomEvent: (e, t, n = {}) => l.publishCustomEvent(e, t)
                        }
                    } catch (b) {
                        return b instanceof y || g(b, {
                            context: "init",
                            shopId: n,
                            initConfig: e
                        }), self.console && console.error(b), m.payload.status = "failed", m.payload.errorMsg = null == b ? void 0 : b.message, x(m), {
                            publish: (...e) => !1,
                            publishCustomEvent: (...e) => !1
                        }
                    } finally {
                        S()
                    }
            ...
            return t instanceof y || g(t, {
                context: "createWebPixelsManager"
            }), self.console && console.error(t), e.payload.status = "failed", e.payload.errorMsg = null == t ? void 0 : t.message, x(e, !0), {}
        }
    }();
