! function() {
    ...
    e(function(e, t) {
            ...
            return c(a, null, [{
                ...
                value: function o(e, t) {
                    ...
                    n.addEventListener("loadend", function() {
                        return t(JSON.parse(String.fromCharCode.apply(String, v(new Uint8Array(n.result)))))
        ...
        p.ADD_TO_CART_REGEX = /^(?:\/[a-zA-Z]+(?:\-[a-zA-Z]+)?)?\/cart\/add(?:\.js|\.json)?$/, t["default"] = p,
            function() {
                function r(e, t, n) {
                ...
                function a(e) {
                    if (!((e = e || window.event).defaultPrevented || e.isDefaultPrevented && e.isDefaultPrevented())) {
                        ...
                        if (t && (t.getAttribute("action") || t.getAttribute("href"))) try {
                            ...
                            window.ShopifyAnalytics.lib.track("Added Product", i), window.ShopifyAnalytics.lib.track("monorail://trekkie_storefront_track_added_product/1.1", c)
                        } catch (d) {
                            console && console.warn && console.warn("[shop_events_listener] Error in handleSubmitCartAdd: " + d.message)
                        }
                    }
                }
                ...
                this._url = t, this._method = e, p.handleXhrOpen(), r.apply(this, arguments)
