! function(c) {
    c.fn.hoverIntent = function(e, t, n) {
        ...
        var o, i, a, u, s = {
            ...
            s = "object" == typeof e ? c.extend(s, e) : c.isFunction(t) ? c.extend(s, {
                over: e,
                out: t,
                selector: n
            }) : c.extend(s, {
            ...
            l = function(e, t) {
                if (t.hoverIntent_t = clearTimeout(t.hoverIntent_t), Math.sqrt((a - o) * (a - o) + (u - i) * (u - i)) < s.sensitivity) return c(t).off("mousemove.hoverIntent", r), t.hoverIntent_s = !0, s.over.apply(t, [e]);
                a = o, u = i, t.hoverIntent_t = setTimeout(function() {
                    l(e, t)
                }, s.interval)
            },
            t = function(e) {
                var n = c.extend({}, e),
                    o = this;
                o.hoverIntent_t && (o.hoverIntent_t = clearTimeout(o.hoverIntent_t)), "mouseenter" === e.type ? (a = n.pageX, u = n.pageY, c(o).on("mousemove.hoverIntent", r), o.hoverIntent_s || (o.hoverIntent_t = setTimeout(function() {
                    l(n, o)
                }, s.interval))) : (c(o).off("mousemove.hoverIntent", r), o.hoverIntent_s && (o.hoverIntent_t = setTimeout(function() {
                    var e, t;
    ...
    function(e, t) {
        ...
        var r, a, u = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {};
        ...
        function d(e, t) {
            if (!h(e) || !r.call(e, "_id")) throw new TypeError(t + " method called on incompatible receiver " + typeof e)
        }
        ...
        function h(e) {
            return Object(e) === e
        }(p = "undefined" != typeof self ? self : "undefined" != typeof window ? window : u).WeakMap || (r = Object.prototype.hasOwnProperty, a = function(e, t, n) {
            Object.defineProperty ? Object.defineProperty(e, t, {
                configurable: !0,
                writable: !0,
                value: n
            }) : e[t] = n
        }, p.WeakMap = (a(s.prototype, "delete", function(e) {
            ...
            if (d(this, "set"), !h(e)) throw new TypeError("Invalid value used as weak map key");
            var n = e[this._id];
        ...
        var p, y = (n = j = {
                ...
                var e, n, o, r, i, a, u = Object.prototype.toString,
                    s = "undefined" != typeof setImmediate ? function(e) {
                ...
                function d() {
                    for (var e = 0; e < this.chain.length; e++) ! function(e, t, n) {
                        var o, r;
                        try {
                            !1 === t ? n.reject(e.msg) : (o = !0 === t ? e.msg : t.call(void 0, e.msg)) === n.promise ? n.reject(TypeError("Promise-chain cycle")) : (r = c(o)) ? r.call(o, n.resolve, n.reject) : n.resolve(o)
                        } catch (e) {
                            n.reject(e)
                        }
                ...
                function f(e) {
                    var t = this;
                    t.triggered || (t.triggered = !0, t.def && (t = t.def), t.msg = e, t.state = 2, 0 < t.chain.length && l(d, t))
                }
                ...
                function y(e) {
                    ...
                    this.then = function(e, t) {
                        ...
                        }), o.chain.push(n), 0 !== o.state && l(d, o), n.promise
                            ...
                            (function e(n) {
                                ...
                                if (!r.triggered) {
                                    ...
                                    try {
                                        ...
                                        }): (r.msg = n, r.state = 1, 0 < r.chain.length && l(d, r))
                                    } catch (e) {
                                        f.call(new p(r), e)
                                    }
                                }
                ...
                var m = e({}, "constructor", y, !(o = {
                    add: function(e, t) {
                        a = new v(e, t), i ? i.next = a : r = a, i = a, a = void 0
                    },
                    drain: function() {
                        var e = r;
                ...
                return e(y.prototype = m, "__NPO__", 0, !1), e(y, "resolve", function(n) {
                    ...
                    var a = this;
                    return "[object Array]" != u.call(t) ? a.reject(TypeError("Not an array")) : 0 === t.length ? a.resolve([]) : new a(function(n, e) {
                    ...
                    var o = this;
                    return "[object Array]" != u.call(t) ? o.reject(TypeError("Not an array")) : new o(function(n, e) {
                        if ("function" != typeof n || "function" != typeof e) throw TypeError("Not a function");
                        h(o, t, function(e, t) {
                            n(t)
                        }, e)
        ...
        function w(e, t, n) {
            ...
            n = o[t].indexOf(n);
            return -1 !== n && o[t].splice(n, 1), v.set(e.element, o), o[t] && 0 === o[t].length
        }
        ...
        function _(i, e, t) {
            ...
            return new Promise(function(t, n) {
                ...
                var e, o = "https://vimeo.com/api/oembed.json?url=".concat(encodeURIComponent(i), "&domain=").concat(window.location.hostname);
                for (e in a) a.hasOwnProperty(e) && (o += "&".concat(e, "=").concat(encodeURIComponent(a[e])));
        ...
        var P = new WeakMap,
            ...
            j = (e(S.prototype, [{
                ...
                value: function(n, o) {
                    var r = this;
                    return new y(function(e, t) {
                        if (n = i(n, "set"), null == o) throw new TypeError("There must be a value to set.");
                ...
                value: function(e, t) {
                    ...
                    0 === g(this, "event:".concat(e)).length && this.callMethod("addEventListener", e).catch(function() {}), m(this, "event:".concat(e), t)
                }
            }, {
                key: "off",
                value: function(e, t) {
                    ...
                    w(this, "event:".concat(e), t) && this.callMethod("removeEventListener", e).catch(function(e) {})
                }
            }, {
                key: "loadVideo",
                value: function(e) {
                ...
                key: "ready",
                value: function() {
                    var e = x.get(this) || new y(function(e, t) {
                ...
                value: function() {
                    ...
                    return new y(function(e) {
                        x.delete(t), P.delete(t.element), t._originalElement && (P.delete(t._originalElement), t._originalElement.removeAttribute("data-vimeo-initialized")), t.element && "IFRAME" === t.element.nodeName && t.element.parentNode && t.element.parentNode.removeChild(t.element), e()
                    })
                }
            }, {
                key: "getAutopause",
        ...
        function S(r) {
            ...
            if (function(e) {
                ...
                }(this), window.jQuery && r instanceof jQuery && (1 < r.length && window.console && console.warn && console.warn("A jQuery object with multiple elements was passed, using the first element."), r = r[0]), "undefined" != typeof document && "string" == typeof r && (r = document.getElementById(r)), e = r, !Boolean(e && 1 === e.nodeType && "nodeName" in e && e.ownerDocument && e.ownerDocument.defaultView)) throw new TypeError("You must pass either a valid element or a valid id.");
            var n = r.ownerDocument.defaultView;
            if ("IFRAME" === r.nodeName || (o = r.querySelector("iframe")) && (r = o), "IFRAME" === r.nodeName && !l(r.getAttribute("src") || "")) throw new Error("The player element passed isn’t a Vimeo embed.");
            ...
            var o = new y(function(a, u) {
                var e = function(e) {
                    if (l(e.origin) && s.element.contentWindow === e.source) {
                        ...
                        if (e || n) return s.element.setAttribute("data-ready", "true"), void a();
                        o = s, n = [], (r = E(r = t)).event ? ("error" === r.event && g(o, r.data.method).forEach(function(e) {
                            var t = new Error(r.data.message);
                            t.name = r.data.name, e.reject(t), w(o, r.data.method, e)
                        }), n = g(o, "event:".concat(r.event)), i = r.data) : !r.method || (t = function(e, t) {
                            var n = g(e, t);
                            if (n.length < 1) return !1;
                            n = n.shift();
                            return w(e, t, n), n
                        }(o, r.method)) && (n.push(t), i = r.value), n.forEach(function(e) {
                            try {
                ...
                n.addEventListener ? n.addEventListener("message", e, !1) : n.attachEvent && n.attachEvent("onmessage", e), "IFRAME" !== s.element.nodeName && _(c(e = T(r, t)), e, r).then(function(e) {
                    var t, n, o = k(e, r);
                    return s.element = o, t = s._originalElement = r, n = o, o = v.get(t), v.set(n, o), v.delete(t), P.set(s.element, s), e
                }).catch(u)
            });
            return x.set(this, o), P.set(this.element, this), "IFRAME" === this.element.nodeName && I(this, "ping"), this
        }
        return t || (function(e) {
            function n(e) {
            ...
            window.VimeoPlayerResizeEmbeds_ || (window.VimeoPlayerResizeEmbeds_ = !0, e = function(e) {
        ...
        var u = "";
        n.expires && ("number" == typeof n.expires || n.expires.toUTCString) && ("number" == typeof n.expires ? (l = new Date).setTime(l.getTime() + 24 * n.expires * 60 * 60 * 1e3) : l = n.expires, u = "; expires=" + l.toUTCString());
    ...
    function(e) {
        ...
        function s(e) {
            ...
            return e.each(function() {
                ...
                null !== n && Math.floor(Math.abs(o - t)) <= 1 ? r[r.length - 1] = n.add(e) : r.push(e), o = t
            }), r
        }
        ...
        var o = -1,
            ...
            c = a.fn.matchHeight = function(e) {
                ...
                if (e.remove) {
                    var n = this;
                    return this.css(e.property, ""), a.each(c._groups, function(e, t) {
        ...
        c.version = "master", c._groups = [], c._throttle = 80, c._maintainScroll = !0, c._beforeUpdate = null, c._afterUpdate = null, c._rows = s, c._parse = u, c._parseOptions = l, c._apply = function(e, t) {
            ...
            return e.each(function() {
            ...
            }), e.css("display", "block"), r.byRow && !r.target && (n.each(function() {
                var e = a(this),
                    t = e.css("display");
                ...
                t.each(function() {
                    var e = a(this),
                        t = 0;
                    r.target && e.is(r.target) || ("border-box" !== e.css("box-sizing") && (t += u(e.css("border-top-width")) + u(e.css("border-bottom-width")), t += u(e.css("padding-top")) + u(e.css("padding-bottom"))), e.css(r.property, o - t + "px"))
                })
            }), e.each(function() {
                var e = a(this);
                e.attr("style", e.data("style-cache") || null)
            }), c._maintainScroll && a(window).scrollTop(i / t * a("html").outerHeight(!0)), this
        ...
        function i(e) {
            c._beforeUpdate && c._beforeUpdate(e, c._groups), a.each(c._groups, function(e) {
                var t = this;
        ...
        YTPlayer = {
            ...
            init: function(e, t) {
                ...
                return r.userOptions = t, r.$body = a("body"), r.$node = a(e), r.$window = a(u), r.defaults.events = {
                    ...
                    onStateChange: function(e) {
                        1 === e.data ? (r.$node.find("img").fadeOut(400), r.$node.addClass("loaded")) : 0 === e.data && r.options.repeat && r.player.seekTo(r.options.start)
                    }
                ...
                }) : "object" == typeof YT ? o() : u.dfd.done(function(e) {
                    o()
                }), r.resize(r), r
            },
            ...
            resize: function(e) {
                ...
                var n, o = t.width(),
                    r = t.height(),
                    i = a("#" + e.holderID);
                o / e.options.ratio < r ? (n = Math.ceil(r * e.options.ratio), i.width(n).height(r).css({
                    left: (o - n) / 2,
                    top: 0
                })) : (e = Math.ceil(o / e.options.ratio), i.width(o).height(e).css({
                    left: 0,
                    top: (r - e) / 2
                })), t = i = null
            },
                    ...
                    if (InventoryProduct) {
                        ...
                        if (variant_inventory_management == "shopify" && variant_inventory_policy != "continue") {
                            if (variant_inventory_quantity > 0) {
                                ...
                                variantInventory.html('<span class=out-of-stock>Sorry!  Out of stock.</span>');
                            }
                        } else {
                            variantInventory.html('<span class=in-stock>In stock!</span>');
                        }
