! function() {
    ...
    (function() {
        window.SPR = function() {
            function n() {}
            return n.shop = Shopify.shop, n.host = window.SPRSettings.apiHost, n.version = "v4", n.api_url = n.host + "/proxy/" + n.version, n.batchSize = window.SPRSettings.batchSize, n.badgeEls = [], n.eventLogger = window.SPRSettings.eventLogger, n.reviewEls = [], n.elSettings = {}, n.$ = void 0, n.extraAjaxParams = {
                shop: n.shop
                ...
                return this.$.each(this.reviewEls, (i = this, function(e, t) {
                    ...
                    if (r = i.$(t).attr("data-id"), "false" !== i.$(t).attr("data-autoload")) return a = i.$.extend({
                        product_id: r,
                        version: i.version
                    }, i.extraAjaxParams), i.$.ajax({
                        url: i.api_url + "/reviews/product",
                        data: a,
                        success: i.productCallback,
                        dataType: "jsonp",
                        jsonpCallback: "productCallback" + r
                    })
                }));
                var i
                ...
                if (0 < (t = this.$.map(this.badgeEls, (i = this, function(e) {
                    ...
                    for (a = []; 0 < (e = t.splice(0, this.batchSize)).length;) r = this.$.extend(this.extraAjaxParams, {
                        product_ids: e
                    }), a.push(this.$.ajax({
                        url: this.api_url + "/reviews/badges",
                        data: r,
                        success: this.badgesCallback,
                        dataType: "jsonp",
                        jsonpCallback: "badgesCallback" + e.join("")
                    }));
                    return a
                }
                ...
                return a = this.$(e).data("product-id"), r = this.$(e).data("page"), t = this.$.extend({
                    page: r,
                    product_id: a
                }, this.extraAjaxParams), this.$.ajax({
                    url: this.api_url + "/reviews",
                    data: t,
                    success: this.paginateCallback,
                    dataType: "jsonp",
                    jsonpCallback: "paginateCallback" + a
                }), !1
